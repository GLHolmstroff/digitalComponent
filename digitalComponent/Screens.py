...
def setUpGame():
    ...
    diceGroup2 = diceGroup(200,500,600,100,'diceGroup1',dice1,dice2,dice3,dice4,dice5,dice6)
    
    diceGroup1 = diceGroup(200,300,600,100,'diceGroup2',dice7,dice8,dice9,dice10,dice11,dice12)
    diceScreen = Screen('diceScreen')
    screenManager.addScreen(diceScreen)
    diceScreen.addItem(diceGroup1)
    diceScreen.addItem(diceGroup2)
    diceScreen.addItem(varBox(900,300,100,100,'dicegroup1out',(diceGroup1,),str(diceGroup1.out),'out',tSize = 20, tColor = color(255)))
    diceScreen.addItem(varBox(900,500,100,100,'dicegroup1out',(diceGroup2,),str(diceGroup2.out),'out',tSize = 20, tColor = color(255)))
    testScreen2.addItem(dropDown(500,500,500,50,'dropdown1','This is a dropdown menu', 'this is option 1', 'this is option 2'))
