...
def setUpGame():
    ...
    shopScreen.addItem(textBox(width - 90, 340, 280, 40, 'troopsTextbox', 'Troops', 20))
    ...
    battleSimScreen.addItem(varFunDropDown(400,675,500,30,'defenderInput',game,'Defender',battle.setDefender,0))
